...
type ModelVersion struct {
	...
	RunnerFamily      *string        `json:"runner_family,omitempty"`
	RunnerManifest    map[string]any `json:"runner_manifest"`
...
// UpdateRunnerConfigInput updates runner-specific metadata on an existing version.
type UpdateRunnerConfigInput struct {
	RunnerImage       *string        `json:"runner_image,omitempty"`
	RunnerFamily      *string        `json:"runner_family,omitempty"`
	RunnerManifest    map[string]any `json:"runner_manifest,omitempty"`
...
type Store interface {
	...
	UpdateVersionRunnerConfig(modelID, versionID string, input UpdateRunnerConfigInput) (ModelVersion, error)
